...
/**
 * Created by Cameron Greatrex on 2024-1-25.
 *
 * @author Cameron Greatrex
 */

public class AbsolutelyAcidicFinal {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < sensors; i++) {
            ...
            // If the reading is already in the hashmap, increment the frequency, if not, add it to the hashmap with a frequency of 1
            // ChatGPT helped me with the .put stuff for hashmaps
