package Test.CellphoneMessaging;

import java.util.Scanner;

public class CellphoneMessagingR1 {
    /**
    ...
    public static void main(String[] args) {
        while (!message.equals("halt")) {
            ...
            System.out.println("Number of pause seconds " + pauseSeconds);
            System.out.println("Number of button seconds " + buttonSeconds);
            buttonSeconds = 0;
            pauseSeconds = 0;
